Gem::Specification.new do |s|
  ...
  s.authors = ["Mike Bueti"]
  s.cert_chain = ["/Users/michaelbueti/.gem/gem-public_cert.pem"]
  s.date = %q{2008-06-17}
  ...
  s.files = ["CHANGELOG", "History.txt", "MIT-LICENSE", "Manifest.txt", "README.txt", "Rakefile", "lib/cinder.rb", "lib/cinder/campfire.rb"]
  s.has_rdoc = true
  ...
  s.signing_key = %q{/Users/michaelbueti/.gem/gem-private_key.pem}
